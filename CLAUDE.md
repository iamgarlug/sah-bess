...
1. **ERCOT** — both ERCOT Nodal Protocols and ERCOT Nodal Operating Guides. Source documents are in `docs/standards/ercot-nodal/protocols-current/` and `docs/standards/ercot-nodal/operating-guides-current/`.
