# ADR-0008: Shared abstractions in a dedicated assembly

**Status:** Accepted

## Context

The hexagonal design ([ADR-0001](0001-hexagonal-architecture.md)) depends on a stable core that does not
