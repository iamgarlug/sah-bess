...
| [0005](0005-target-framework.md) | Target framework .NET 10 (LTS) + xUnit | Proposed |
| [0006](0006-database-historian.md) | Historian store: TimescaleDB (recommended) | Deferred |
| [0007](0007-matlab-integration.md) | MATLAB integration: MATLAB-exported C# assemblies | Accepted |
| [0008](0008-ci-platform.md) | CI/CD platform: GitHub Actions + Environments | Proposed |
| [0009](0009-shared-abstractions-assembly.md) | Shared abstractions in a dedicated assembly | Accepted |
| [0010](0010-regulatory-conformance.md) | Regulatory conformance approach | Proposed |
